...
check1, check2, check3 = 630,2500,2100
...
data_pos_1 = pd.concat((df1_1.sample(150),df2.sample(151 - 150 ) )).drop_duplicates()
data_pos_1['labels'] = 0
df1_1['labels'] = 0
...
data_pos_3 = pd.concat((df1_3.sample(3500),df2.sample(3501 - 3500) )).drop_duplicates()
data_pos_3['labels'] = 2
df1_3['labels'] = 2
...
for K in tqdm(range(repeats)):
    ...
    data_pos_in_1 = data_pos_1.sample(151)
    data_pos_in_2 = data_pos_2.sample(P_samples)
    data_pos_in_3 = data_pos_3.sample(3500)
...
f ='./AUCACC_performance_multiclass_epochs_{}_batchsize_{}_three_min_funbal_mod.csv'.format(EPOCHS,batch_size)
if os.path.isfile(f):
