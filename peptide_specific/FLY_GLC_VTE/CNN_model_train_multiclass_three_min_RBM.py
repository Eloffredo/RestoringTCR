...
df2 = pd.read_csv(f'./Generated_binders_{peptide1}_RBM_beta{beta:.2f}_wEPOCHS{check1}.csv').drop_duplicates()
...
df2 = pd.read_csv(f'./Generated_binders_{peptide3}_RBM_beta{beta:.2f}_wEPOCHS{check3}.csv').drop_duplicates()
df2 = df2[df2['CDR3b'].str.len()>7]
