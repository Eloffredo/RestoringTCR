...
data_pos_3 = pd.concat((df1_3.sample(60),df2.sample(P_samples - 60) )).drop_duplicates()
data_pos_3['labels'] = 2
df1_3['labels'] = 2
...
for K in tqdm(range(repeats)):
    ...
    data_pos_in_3 = data_pos_3.sample(61)
...
f ='./AUCACC_performance_multiclass_epochs_{}_batchsize_{}_three_min_nogen.csv'.format(EPOCHS,batch_size)
if os.path.isfile(f):
