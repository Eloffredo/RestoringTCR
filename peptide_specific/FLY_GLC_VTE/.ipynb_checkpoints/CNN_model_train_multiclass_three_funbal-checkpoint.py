...
peptide1, peptide2, peptide3 = 'FLYNLLTRV','GLCTLVAML','VTEHDTLLY'
check1, check2, check3 = 990,2100,630
...
data_pos_1 = pd.concat((df1_1.sample(60),df2.sample(61 - 60 ) )).drop_duplicates()
data_pos_1['labels'] = 0
df1_1['labels'] = 0
...
data_pos_3 = pd.concat((df1_3.sample(150),df2.sample(151 - 150) )).drop_duplicates()
data_pos_3['labels'] = 2
df1_3['labels'] = 2
...
for K in tqdm(range(repeats)):
    ...
    data_pos_in_1 = data_pos_1.sample(61)
    data_pos_in_2 = data_pos_2.sample(P_samples)
    data_pos_in_3 = data_pos_3.sample(151)
