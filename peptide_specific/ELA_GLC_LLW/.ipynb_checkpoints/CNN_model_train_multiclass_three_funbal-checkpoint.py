...
peptide1, peptide2, peptide3 = 'ELAGIGILTV','GLCTLVAML','LLWNGPMAV'
check1, check2, check3 = 110,2100,630
...
data_pos_1 = pd.concat((df1_1.sample(700),df2.sample(701 - 700 ) )).drop_duplicates()
data_pos_1['labels'] = 0
df1_1['labels'] = 0
...
data_pos_3 = pd.read_csv(f'./Binders_{peptide3}.csv').drop_duplicates()
data_pos_3['labels'] = 2
...
for K in tqdm(range(repeats)):
    ...
    data_pos_in_1 = data_pos_1.sample(701)
    data_pos_in_2 = data_pos_2.sample(3500)
    ...
    pos_test_3 = data_pos_3[~data_pos_3['CDR3b'].isin(data_pos_in_3['CDR3b'])].dropna().sample(T)
